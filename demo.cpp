...
Demo::Demo(QWidget *parent):QDialog(parent)
{
    ...
    styleComboBox->addItem("BlueSytle");
    styleComboBox->addItems(QStyleFactory::keys());

    styleLabel = new QLabel(tr("&Style:"));
    styleLabel->setBuddy(styleComboBox);//快捷键选择
    ...
    changeStyle("BlueStyle");
}

void Demo::changeStyle(const QString &styleName)
{
    if (styleName == "BlueStyle") {
        QApplication::setStyle(new BlueStyle);
    } else {
...
void Demo::createTopLeftGroupBox()
{
...
void Demo::createTopRightGroupBox()
{
...
void Demo::createBottomLeftTabWidget()
{
...
void Demo::createBottomRightGroupBox()
{
